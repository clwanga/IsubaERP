                                ...
                                <div class="grid grid-cols-4 gap-1">
                                    <div>
                                        <form action="{{ route('register.status_update', $user) }}" method="post">
                                            ...
                                            @method('put')
                                            @if ($user->is_active)
                                                <button title="Deactivate User" type="submit"
                                            ...
                                            @else
                                                <button title="Activate User" type="submit"
                                    ...
                                    <div>
                                        <form action="{{ route('register.reset_password', $user) }}" method="post">
                                            @csrf
                                    ...
                                    <div>
                                        <button title="Edit User" type="button"
                                            data-modal-target="edit_user{{ $user->id }}"
                                            data-modal-toggle="edit_user{{ $user->id }}"
                                        ...
                                        <div id="edit_user{{ $user->id }}" tabindex="-1" aria-hidden="true"
                                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                                <!-- Modal content -->
                                                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button"
                                                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                            data-modal-hide="edit_user{{ $user->id }}">
                                                    ...
                                                    <div class="p-4 md:p-5 space-y-4">
                                                        <form class="mx-4" method="post"
                                                            ...
                                                            <x-submit-btn btnText="edit user"></x-submit-btn>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div>
                                        <form action="{{ route('register.delete', $user) }}" method="post">
                                            ...
                                            <button title="Delete User" type="submit"
                                                class=" text-red-800 hover:cursor-pointer">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                    class="size-4">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
