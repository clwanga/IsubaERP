                        ...
                        <li>
                            <a href="{{ route('sales') }}"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6 class="shrink-0 w-5 h-5
                                    text-white transition duration-75 dark:text-gray-400 group-hover:text-white
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap text-sm font-semibold">Sales</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('logout') }}"
